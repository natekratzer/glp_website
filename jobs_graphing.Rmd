...
png("jobs_job_creation_rate_births_ranking.png", 900, 600, res = 100, type = "cairo")
rank_and_nb_group(filter(jobs_data_msa, year == 2014),
...
png("jobs_job_creation_rate_births_trendline.png", 900, 600, res = 100, type = "cairo")
graph_trendline_msa(jobs_data_msa, 
                    'job_creation_rate_births',
...
png("jobs_job_destruction_rate_deaths_trendline.png", 900, 600, res = 100, type = "cairo")
graph_trendline_msa(jobs_data_msa, 
                    'job_destruction_rate_deaths',
