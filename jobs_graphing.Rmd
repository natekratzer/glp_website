...
jobs_map_data <- read_csv("input data/jobs_input_data/ACS_15_5YR_S2001_with_ann.csv", skip = 1)
jobs_map_data <- jobs_map_data %>% select(Id, Id2, earnings = `Total; Estimate; Median earnings (dollars)`)
jobs_map_data$earnings = as.numeric(jobs_map_data$earnings)
...
```{r}
setwd("C:/Users/natek/Documents/images")
m <- make_map("earnings", "Median Earnings", order = "Descending")
saveWidget(m, "jobs_earnings_map.html")
