...
jpeg("qp_child_poverty_rankings.jpg", 900, 600, res = 100)
showtext.begin()
rank_and_nb_group(
...
jpeg("qp_child_poverty_trendline.jpg", 900, 600, res = 100)
showtext.begin()
graph_trendline(qp_data_fips, "child_per",
                plot_title = "Child Poverty",
                rollmean = 3,
                caption_text = "Source: Greater Louisville Project \nData from American Community Survey Table B17001",
                xmin = 2005, xmax = 2015, y_title = "Percent")
showtext.end()
dev.off()
```
...
```{r}
setwd("~/Desktop/glp_website/Images/Maps/qp_maps")
