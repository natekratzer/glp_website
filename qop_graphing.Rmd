...
jpeg("qp_millennial_migration_rankings.jpg", 900, 600, res = 100)
showtext.begin()
rank_and_nb_group(
  as.data.frame(filter(qp_data_fips, year == 2015)),
  'mil_mig_per_100000',
...
jpeg("qp_millennial_migration_trendline.jpg", 900, 600, res = 100)
showtext.begin()
graph_trendline(qp_data_fips, "mil_mig_per_100000",
                ...
                xmin = 2010, xmax = 2015, y_title = "Number of Millennials (Ages 25-34) moving to the city from another\ncounty, state, or country per 100,000")
showtext.end()
dev.off()
...
m <- make_map("mpi", "MPI", order = "Descending", units = "none")
...
m <- make_map("pct_white", "White Population", order = "Descending",
              col_palette = "Oranges")
saveWidget(m, "qp_pct_white_map_descending-1.html")

m <- make_map("pct_white", "White Population", order = "Descending",
              col_palette = "Greens")
saveWidget(m, "qp_pct_white_map_descending-2.html")

m <- make_map("pct_white", "White Population", order = "Descending",
              col_palette = "Greys")
saveWidget(m, "qp_pct_white_map_descending-3.html")
...
m <- make_map("median_income", "Median Household Income", order = "Descending", units = "Dollars", col_palette = "RdYlGn")
saveWidget(m, "qp_median_income_map.html")

m <- make_map("median_income", "Median Household Income", order = "Descending", units = "Dollars", col_palette = "RdBu")
saveWidget(m, "qp_median_income_map-2.html")

m <- make_map("median_income", "Median Household Income", order = "Descending", units = "Dollars", col_palette = "RdYlBu")
saveWidget(m, "qp_median_income_map-3.html")
```
