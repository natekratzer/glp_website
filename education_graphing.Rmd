...
```{r}
setwd("C:/Users/natek/Documents/images")
m <- make_map("child_per", "Child Percent", order = "Ascending")
...
m <- make_map("per_25_64_bach_plus", "Associate Degrees, 25-64")
saveWidget(m, "edu_25_64_bach_map.html")

m <- make_map("per_25_64_grad", "Associate Degrees, 25-64")
...
m <- make_map("per_25_34_bach_plus", "Associate Degrees, 25-34")
saveWidget(m, "edu_25_34_bach_map.html")

m <- make_map("per_25_34_grad", "Associate Degrees, 25-34")
saveWidget(m, "edu_25_34_grad_map.html")

m <- make_map("per_high_wage", "High Wage Occupations")
saveWidget(m, "per_high_wage_map.html")
