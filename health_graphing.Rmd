...
Rescaling some health values
```{r}
#write_csv(health_values, "C:/Users/natek/Documents/Github/glp_website/data/health data values.csv")
```
...
showtext.begin()
rank_and_nb_group(health_values, "food_environment_index", order = "Descending",
...
showtext.begin()
rank_and_nb_group(health_values, "access_to_exercise_opportunities", order = "Descending",
...
showtext.begin()
rank_and_nb_group(health_values, "dentists", order = "Descending",
                  plot_title = "Dentists", 
                  y_title = "Per 100,000",
                  caption_text = "Source: Greater Louisville Project \nData from the Robert Wood Johnson Foundation 2017 County Health Rankings")
showtext.end()
...
showtext.begin()
rank_and_nb_group(health_values, "mental_health_providers", order = "Descending",
...
showtext.begin()
rank_and_nb_group(health_values, "diabetes_monitoring", order = "Descending",
...
showtext.begin()
rank_and_nb_group(health_values, "mammography_screening", order = "Descending",
...
showtext.begin()
rank_and_nb_group(health_values, "social_associations", order = "Descending",
                  plot_title = "Social Associations", 
                  y_title = "Number of Associations per 10,000 population",
                  caption_text = "Source: Greater Louisville Project \nData from the Robert Wood Johnson Foundation 2017 County Health Rankings")
showtext.end()
dev.off()
