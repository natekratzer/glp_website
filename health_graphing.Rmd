...
rank_and_nb_group<-function(df, var, order="Descending", peers="Current",
  ...
  d.graph$round <- format(signif(d.graph$var, digits = sigfig), nsmall = num_dec)
...
showtext.begin()
rank_and_nb_group(filter(health_data_fips, year == 2017), "primary_care_physicians", order = "Ascending", sigfig = 3, num_dec = 0,
