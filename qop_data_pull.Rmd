...
# setwd("~/Desktop/glp_website/input data/qp_input_data") #Need to run fxn to get cbp_read to run inside of a R notebook chunk
...
weights<-read_csv("~/Desktop/glp_website/input data/qp_input_data/FIPS_two_stl.csv", col_types = cols(FIPS = col_integer()), progress = FALSE) 
