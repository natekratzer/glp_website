...
#Add Social Associations code from QP
```{r}
...
health_data_fips <- full_join(sc_data, health_data_fips, by = c("FIPS", "year", "baseline","city","current"))

```

Add GeoFRED Commute Time Data Analysis
```{r}
